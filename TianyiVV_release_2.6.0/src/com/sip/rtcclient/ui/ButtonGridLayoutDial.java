...
public class ButtonGridLayoutDial extends ViewGroup {
    ...
    public ButtonGridLayoutDial(Context context) {
        super(context);
        this.context=context;
    }

    public ButtonGridLayoutDial(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context=context;
    }

    public ButtonGridLayoutDial(Context context, AttributeSet attrs, int defStyle) {
...
//        mWidth=this.getMeasuredWidth();
        Log.e("ljp", "mButtonWidth:"+mButtonWidth+"mButtonHeight:"+mButtonHeight+"mWidth:"+mWidth);
