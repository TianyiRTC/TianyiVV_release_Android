...
public class ButtonGridVideoLayout extends ViewGroup {
    ...
    public ButtonGridVideoLayout(Context context) {
        super(context);
        this.context=context;
    }

    public ButtonGridVideoLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context=context;
    }

    public ButtonGridVideoLayout(Context context, AttributeSet attrs, int defStyle) {
...
//        CommFunc.PrintLog(5,"ljp", "mButtonWidth:"+mButtonWidth+"mButtonHeight:"+mButtonHeight+"mWidth:"+mWidth);
