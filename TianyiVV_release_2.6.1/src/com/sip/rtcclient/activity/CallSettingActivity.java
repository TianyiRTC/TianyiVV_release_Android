...
public class CallSettingActivity extends BaseActivity implements OnTianyiTitleActed {
    ...
    private CheckBox call_opengl_cb;
    private CheckBox call_auto_accept_cb;
    ...
    private void initData()
    {
        ...
        int acc = MyApplication.getInstance().getIntSharedXml(MsgKey.KEY_AUTOACP, 1);
        if(acc == 1)
            call_auto_accept_cb.setChecked(true);
        else
        	call_auto_accept_cb.setChecked(false);
        
        int formate = MyApplication.getInstance().getIntSharedXml(MsgKey.KEY_VFORMAT, 2);
    ...
    private void initView() {
        ...
        call_auto_accept_cb = (CheckBox)findViewById(R.id.call_auto_accept_cb);
    ...
    private void SaveConfig()
    {
        ...
        if(call_auto_accept_cb.isChecked())
            MyApplication.getInstance().saveSharePrefValue(MsgKey.KEY_AUTOACP, "1");
        else
            MyApplication.getInstance().saveSharePrefValue(MsgKey.KEY_AUTOACP, "0");
