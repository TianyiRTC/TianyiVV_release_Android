...
public class OpenFileDialog {
	...
	static final public String sRoot = "/sdcard/rtcsdk/log"; 
	...
	static class FileSelectView extends ListView implements OnItemClickListener{
		...
		private int refreshFileList()
		{
			...
			SimpleAdapter adapter = new SimpleAdapter(getContext(), list, R.layout.activity_setting_upload, new String[]{"img", "name"}, new int[]{R.id.filedialogitem_img, R.id.filedialogitem_name});
