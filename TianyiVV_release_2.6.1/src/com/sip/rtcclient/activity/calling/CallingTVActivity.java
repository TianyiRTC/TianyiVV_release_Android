            ...
            HBaseApp.post2WorkRunnable(new Runnable() {
                ...
                public void run() {
                    ...
                    try {
                        ...
                        if(MyApplication.getInstance().getIntSharedXml(MsgKey.KEY_VCODEC, MsgKey.VCODEC_VP8) == MsgKey.VCODEC_VP8)
                            jsonObj.put(RtcConst.klivecodec, RtcConst.VCodec_VP8);
                        else
                            jsonObj.put(RtcConst.klivecodec, RtcConst.VCodec_H264);
